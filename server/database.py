...
class QuizDB:
    ...
    def __init__(self, location):
        ...
        for filename in glob.iglob(os.path.join(config.basedir, self.location, '**/*.json'), recursive=True):
    ...
    def get_submission(self, username, quiz_id):
        return self.submissions_data[TRACE(self.get_filename(username, quiz_id))]
    ...
    def get_filename(self, username, quiz_id):
        return os.path.join(config.basedir, self.location, username, quiz_id + ".json")
